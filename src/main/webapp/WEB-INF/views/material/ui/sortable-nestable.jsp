...
<head>
    ...
    <!-- JQuery Nestable Css -->
    <link rel="stylesheet" type="text/css" href="${CTX_PATH}/material/plugins/nestable/jquery-nestable.css?v=${SYS_VERSION}" />
...
<!--             </div> -->
    ...
    <!-- Jquery Nestable -->
    <script src="${CTX_PATH}/material/plugins/nestable/jquery.nestable.js?v=${SYS_VERSION}"></script>



    <script src="${CTX_PATH}/material/js/ui/sortable-nestable.js?v=${SYS_VERSION}"></script>
