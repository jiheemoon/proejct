...
<!--             </div> -->
    ...
    <script src="${CTX_PATH}/material/plugins/bootstrap-notify/bootstrap-notify.js?v=${SYS_VERSION}"></script>
    ...
    <script src="${CTX_PATH}/material/js/ui/notifications.js?v=${SYS_VERSION}"></script>
