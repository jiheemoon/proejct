...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../plugins/light-gallery/css/lightgallery.css" />
...
<body class="theme-black">
    ...
    <script src="../../plugins/light-gallery/js/lightgallery-all.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../js/pages/medias/image-gallery.js?v=${SYS_VERSION}"></script>
