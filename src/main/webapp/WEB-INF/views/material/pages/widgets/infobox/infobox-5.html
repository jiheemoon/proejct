...
<body class="theme-black ls-opened">
    ...
    <script src="../../../plugins/jquery-countto/jquery.countTo.js?v=${SYS_VERSION}"></script>

    <!-- Sparkline Chart Plugin Js -->
    <script src="../../../plugins/jquery-sparkline/jquery.sparkline.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../../js/admin.js?v=${SYS_VERSION}"></script>
    <script src="../../../js/helpers.js?v=${SYS_VERSION}"></script>
    <script src="../../../js/pages/widgets/infobox/infobox-5.js?v=${SYS_VERSION}"></script>
