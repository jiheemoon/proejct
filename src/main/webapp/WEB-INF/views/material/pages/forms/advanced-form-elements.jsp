...
<head>
    ...
    <!-- Colorpicker Css -->
    <link rel="stylesheet" type="text/css" href="../../plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css" />

    <!-- Dropzone Css -->
    <link rel="stylesheet" type="text/css" href="../../plugins/dropzone/dropzone.css" />

    <!-- Multi Select Css -->
    <link rel="stylesheet" type="text/css" href="../../plugins/multi-select/css/multi-select.css" />

    <!-- Bootstrap Spinner Css -->
    <link rel="stylesheet" type="text/css" href="../../plugins/jquery-spinner/css/bootstrap-spinner.css" />
...
<body class="theme-black">
    ...
    <script src="../../plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js?v=${SYS_VERSION}"></script>

    <!-- Dropzone Plugin Js -->
    <script src="../../plugins/dropzone/dropzone.js?v=${SYS_VERSION}"></script>

    <!-- Input Mask Plugin Js -->
    <script src="../../plugins/jquery-inputmask/jquery.inputmask.bundle.js?v=${SYS_VERSION}"></script>

    <!-- Multi Select Plugin Js -->
    <script src="../../plugins/multi-select/js/jquery.multi-select.js?v=${SYS_VERSION}"></script>

    <!-- Jquery Spinner Plugin Js -->
    <script src="../../plugins/jquery-spinner/js/jquery.spinner.js?v=${SYS_VERSION}"></script>

    <!-- Bootstrap Tags Input Plugin Js -->
    <script src="../../plugins/bootstrap-tagsinput/bootstrap-tagsinput.js?v=${SYS_VERSION}"></script>

    <!-- noUISlider Plugin Js -->
    <script src="../../plugins/nouislider/nouislider.js?v=${SYS_VERSION}"></script>
    ...
    <script src="../../js/pages/forms/advanced-form-elements.js?v=${SYS_VERSION}"></script>
