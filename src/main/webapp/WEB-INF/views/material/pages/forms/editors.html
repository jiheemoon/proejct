...
<body class="theme-black">
    ...
    <!-- Ckeditor -->
    <script src="../../plugins/ckeditor/ckeditor.js?v=${SYS_VERSION}"></script>

    <!-- TinyMCE -->
    <script src="../../plugins/tinymce/tinymce.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../js/admin.js?v=${SYS_VERSION}"></script>
    <script src="../../js/pages/forms/editors.js?v=${SYS_VERSION}"></script>
