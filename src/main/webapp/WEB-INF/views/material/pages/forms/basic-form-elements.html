...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../plugins/bootstrap-datepicker/css/bootstrap-datepicker.css" />
...
<body class="theme-black">
    ...
    <!-- Autosize Plugin Js -->
    <script src="../../plugins/autosize/autosize.js?v=${SYS_VERSION}"></script>

    <!-- Moment Plugin Js -->
    <script src="../../plugins/momentjs/moment.js?v=${SYS_VERSION}"></script>

    <!-- Bootstrap Material Datetime Picker Plugin Js -->
    <script src="../../plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js?v=${SYS_VERSION}"></script>

    <!-- Bootstrap Datepicker Plugin Js -->
    <script src="../../plugins/bootstrap-datepicker/js/bootstrap-datepicker.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../js/admin.js?v=${SYS_VERSION}"></script>
    <script src="../../js/pages/forms/basic-form-elements.js?v=${SYS_VERSION}"></script>
