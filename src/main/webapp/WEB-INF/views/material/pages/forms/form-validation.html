...
<body class="theme-black">
    ...
    <script src="../../plugins/jquery-steps/jquery.steps.js?v=${SYS_VERSION}"></script>

    <!-- Sweet Alert Plugin Js -->
    <script src="../../plugins/sweetalert/sweetalert.min.js?v=${SYS_VERSION}"></script>
    ...
    <script src="../../js/pages/forms/form-validation.js?v=${SYS_VERSION}"></script>
