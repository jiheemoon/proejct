...
<head>
    ...
    <!-- Range Slider Css -->
    <link rel="stylesheet" type="text/css" href="../../plugins/ion-rangeslider/css/ion.rangeSlider.css" />
    <link rel="stylesheet" type="text/css" href="../../plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.css" />
...
<body class="theme-black">
    ...
    <script src="../../plugins/ion-rangeslider/js/ion.rangeSlider.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../js/admin.js?v=${SYS_VERSION}"></script>
    <script src="../../js/pages/ui/range-sliders.js?v=${SYS_VERSION}"></script>
