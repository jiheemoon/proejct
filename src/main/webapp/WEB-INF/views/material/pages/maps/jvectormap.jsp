...
<body class="theme-black">
    ...
    <script src="../../plugins/jvectormap/jquery-jvectormap-1.2.2.min.js?v=${SYS_VERSION}"></script>
    <script src="../../plugins/jvectormap/jquery-jvectormap-world-mill-en.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../js/admin.js?v=${SYS_VERSION}"></script>
    <script src="../../js/pages/maps/jvectormap.js?v=${SYS_VERSION}"></script>
