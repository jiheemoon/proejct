...
<body class="theme-black">
    ...
    <script src="../../plugins/flot-charts/jquery.flot.js?v=${SYS_VERSION}"></script>
    <script src="../../plugins/flot-charts/jquery.flot.resize.js?v=${SYS_VERSION}"></script>
    <script src="../../plugins/flot-charts/jquery.flot.pie.js?v=${SYS_VERSION}"></script>
    <script src="../../plugins/flot-charts/jquery.flot.categories.js?v=${SYS_VERSION}"></script>
    <script src="../../plugins/flot-charts/jquery.flot.time.js?v=${SYS_VERSION}"></script>

    <!-- Custom Js -->
    <script src="../../js/admin.js?v=${SYS_VERSION}"></script>
    <script src="../../js/pages/charts/flot.js?v=${SYS_VERSION}"></script>
