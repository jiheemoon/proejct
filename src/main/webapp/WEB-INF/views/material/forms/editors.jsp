...
<!--             </div> -->
    ...
    <!-- Ckeditor -->
    <script src="${CTX_PATH}/material/plugins/ckeditor/ckeditor.js?v=${SYS_VERSION}"></script>

    <!-- TinyMCE -->
    <script src="${CTX_PATH}/material/plugins/tinymce/tinymce.js?v=${SYS_VERSION}"></script>



    <script src="${CTX_PATH}/material/js/forms/editors.js?v=${SYS_VERSION}"></script>
