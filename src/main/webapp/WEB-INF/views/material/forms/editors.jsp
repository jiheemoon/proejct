...
<!--             </div> -->
    ...
    <!-- Ckeditor -->
    <script src="${CTX_PATH}/plugins/ckeditor/ckeditor.js?v=${SYS_VERSION}"></script>

    <!-- TinyMCE -->
    <script src="${CTX_PATH}/plugins/tinymce/tinymce.js?v=${SYS_VERSION}"></script>



    <script src="${CTX_PATH}/js/material/forms/editors.js?v=${SYS_VERSION}"></script>
