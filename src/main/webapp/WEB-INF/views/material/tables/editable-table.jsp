...
<!--             </div> -->
    ...
    <script src="${CTX_PATH}/material/plugins/editable-table/mindmup-editabletable.js?v=${SYS_VERSION}"></script>



    <script src="${CTX_PATH}/material/js/tables/editable-table.js?v=${SYS_VERSION}"></script>
