...
<!--             </div> -->
    ...
    <script src="${CTX_PATH}/material/plugins/jquery-countto/jquery.countTo.js?v=${SYS_VERSION}"></script>
    ...
    <script src="${CTX_PATH}/material/js/helpers.js?v=${SYS_VERSION}"></script>
    <script src="${CTX_PATH}/material/js/widgets/infobox/infobox-5.js?v=${SYS_VERSION}"></script>
