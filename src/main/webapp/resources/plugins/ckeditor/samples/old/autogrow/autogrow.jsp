...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${CTX_PATH}/samples/old/sample.css">
...
<body>
	<h1 class="samples">
		<a href="${CTX_PATH}/samples/old/index.html">CKEditor Samples</a> &raquo; Using AutoGrow Plugin
	</h1>
