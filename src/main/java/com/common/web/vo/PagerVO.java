...
public class PagerVO extends ValueObject {

    private static final long serialVersionUID = -7416931194937252805L;
    ...
    /**
     * @param sRowNum the sRowNum to set
     */
    ...
    /**
     * @param eRowNum the eRowNum to set
     */
