...
public abstract class AbstractMapper extends SqlSessionDaoSupport {
     ...
     * @return
     */
    public String getSqlMappedStatement(String id, Class<?> beanClass, Object bean) {

        return (getSqlMappedStatement(id, ObjectUtil.convertObjectToMap(beanClass, bean)));
    }
     ...
     * @return
     */
    public String getSqlMappedStatement(String id, String key, Object value) {

        String sqlStatement = "";
        try {
            Map<String, Object> params = new HashMap<String, Object>();
            params.put(key, value);
            sqlStatement = getSqlMappedStatement(id, params);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return (sqlStatement);
     ...
     * @return
     */
    public String getSqlMappedStatement(String id, Map<String, Object> params) {
        
        return (getSqlMappedStatement(getSqlSession(), id, params));
    }
     ...
     * @return
     */
    public String getSqlMappedStatement(SqlSession sqlSession, String id, Map<String, Object> params) {
                    ...
                    for (ParameterMapping mapping : paramMapping) {
                        ...
                        if (null != propValue) {
                            ...
                            if (propValue instanceof String) {
                                sqlStatement = sqlStatement.replaceFirst("\\?", "'" + value + "'");
                            } else {
                                sqlStatement = sqlStatement.replaceFirst("\\?", StringUtil.isEmpty(value) ? "NULL" : value);
                            }
                        } else {
